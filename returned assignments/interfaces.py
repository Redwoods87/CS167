# 2/2 - Show buttons for thrust and no thrust
# 2/2 - Modify get_thrust to implement their behavior
# 2/2 - Modify show_info to show current Fuel, Velocity, and Altitude
# 2/2 - Modify end_game methods to give feedback, wait for click
# 2/2 - Above & Beyond
# 2/2 - Style and following directions
#
# GRADE: 12/12
# You did it!
