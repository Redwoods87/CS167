# orf1
# 1/1 Iterates over codons 
# 1/1 ... in given reading frame
# 1/1 Looks for start and stop codons
# 1/1 Sets turtle color to blue when entering a orf, red when exiting
# 1/1 Calls given bar() function
# 
# gcFreq
# 1/1 Computes gccount correctly for each window
# 1/1 Divides gccount by window to get a frequency
# 1/1 Calls given plot() function
# 1/1 Plot correctly aligned with dna sequence (per example output)
# 1/1 Computes initial window and then sliding window (as specified)
#
